...
const CONFIG = {
  ...
  WHATSAPP_MESSAGE: 'Olá! Quero mais detalhes sobre a Masterclass de Lógica de Programação (30 de Setembro de 2026) e fazer parte do grupo.',
...
/* ==========================================================================
   ...
   Aqui só acrescentamos a mensagem pré-escrita (CONFIG.WHATSAPP_MESSAGE).
   ========================================================================== */
function initWhatsappLinks() {
  if (!CONFIG.WHATSAPP_MESSAGE) return;
  const text = encodeURIComponent(CONFIG.WHATSAPP_MESSAGE);

  $$('[data-whatsapp-link]').forEach((link) => {
    const base = link.href.split('?')[0];
    link.href = `${base}?text=${text}`;
  });
}
